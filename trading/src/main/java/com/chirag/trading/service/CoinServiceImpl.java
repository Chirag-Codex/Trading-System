    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            if (marketData != null) {
                ...
                if (marketData.has("price_change_24h_in_currency") &&
                        marketData.get("price_change_24h_in_currency").has("usd")) {
                  }
                if (marketData.has("price_change_percentage_24h_in_currency") &&
                        marketData.get("price_change_percentage_24h_in_currency").has("usd")) {
                    }
