...
export const TOP_50_COINS_REQUEST = "TOP_50_COINS_REQUEST";
export const TOP_50_COINS_SUCCESS = "TOP_50_COINS_SUCCESS"; 
export const TOP_50_COINS_FAILURE = "TOP_50_COINS_FAILURE";
