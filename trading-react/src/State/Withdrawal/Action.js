...
export const withdrawalRequest =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await api.post(`/api/withdrawal/request/${amount}`, null, {
        headers: {
...
export const getWithdrawalRequest=jwt=> async (dispatch)=>{
...
export const addPaymentDetails=({jwt,paymentDetails})=> async (dispatch)=>{
    ...
    try {
        ...
        console.log("Added Payment Details---",response.data);
